      ...
      <div className="max-w-7xl mx-auto space-y-[70px]">
          <div className="max-w-[800px] mx-auto space-y-[15px]">
            ...
            <p className="text-[20px] text-center text-black/80">
              Simplify how you send, spend, and manage money with intelligent tools
          ...
          <div className=" h-full">
            <div className="space-y-[30px]">
                {overview.map((view) => (
                  <div key={view.id} className={`flex items-center h-[490px] gap-20 ${Number(view.id) % 2 === 0 ? 'flex-row-reverse' : 'flex'}`}>
                    <div className="w-1/2 h-full bg-purple-100"></div>
                    <div className="w-1/2 border  space-y-6">
                      ...
                      <button className="py-[15px] px-[25px] bg-purple-900 text-white rounded-full">
                        See how it works
                      </button>
                    </div>
                  </div>
